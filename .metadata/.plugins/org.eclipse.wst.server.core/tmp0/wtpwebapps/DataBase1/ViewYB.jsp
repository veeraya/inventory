...
function onloaded()
{
	<%YB.startfilter(); 
	if(YB.YB.getRows()==0)
	out.println("alert('YB Table Empty')");%>
...
<P><input type="SUBMIT" Style="height:40px;border-radius: 5px;-moz-border-radius:5px;background-color:#99CC33;valign=top;" value="Reload Data" onClick="window.location='ViewYB.jsp' "> 
