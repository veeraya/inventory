...
<INPUT Style="width: 120px;height:70px;color:white;background-color:#FF0000;border-radius: 5px;-moz-border-radius:5px;"  Value = "BOX Orders" onclick = "window.location='View1OnlyBox.jsp'" TYPE='SUBMIT'>
...
<tbody>
<tr>
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'><select  style='width:40px;overflow:hidden;border-radius: 5px;-moz-border-radius:5px;background-color:#F5F1F0;' onchange = "getList(1)" id="Filter1">
<%
...
<td style='background-color: #C3BEBD;font-size:11'><select  style='width:40px;overflow:hidden;border-radius: 5px;-moz-border-radius:5px;background-color:#F5F1F0;' onchange = "getList(2)" id="Filter2">
<%
	 Uval = database2.getUniqueCol(1);
	for(int k=0;k<Uval.size();k++)
	{
		out.println("<option value="+Uval.get(k)+">"+Uval.get(k)+"</option>");
	}
...
<td style='background-color: #C3BEBD;font-size:11'>
...
<td style='background-color: #C3BEBD;font-size:11'><select  style='width:40px;overflow:hidden;border-radius: 5px;-moz-border-radius:5px;background-color:#F5F1F0;resize:none;' onchange = "getList(7)" id="Filter7">
<%
	 Uval = database2.getUniqueCol(6);
	for(int k=0;k<Uval.size();k++)
	{
		out.println("<option value="+Uval.get(k)+">"+Uval.get(k)+"</option>");
	}
...
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'><select  style='width:40px;overflow:hidden;border-radius: 5px;-moz-border-radius:5px;background-color:#F5F1F0;' onchange = "getList(11)"id="Filter11">
<%
	 Uval = database2.getUniqueCol(10);
	for(int k=0;k<Uval.size();k++)
	{
		out.println("<option value="+Uval.get(k)+">"+Uval.get(k)+"</option>");
	}
...
<%
	 Uval = database2.getUniqueCol(11);
	for(int k=0;k<Uval.size();k++)
	{
		out.println("<option value="+Uval.get(k)+">"+Uval.get(k)+"</option>");
	}
...
<%
	 Uval = database2.getUniqueCol(12);
	for(int k=0;k<Uval.size();k++)
	{
		out.println("<option value="+Uval.get(k)+">"+Uval.get(k)+"</option>");
	}
...
<td style='background-color: #C3BEBD;font-size:11'><select  style='width:40px;overflow:hidden;border-radius: 5px;-moz-border-radius:5px;background-color:#F5F1F0;' onchange = "getList(14)" id="Filter14">
<%
	 Uval = database2.getUniqueCol(13);
	for(int k=0;k<Uval.size();k++)
	{
		out.println("<option value="+Uval.get(k)+">"+Uval.get(k)+"</option>");
	}
...
<td style='background-color: #C3BEBD;font-size:11'><select  style='width:40px;overflow:hidden;border-radius: 5px;-moz-border-radius:5px;background-color:#F5F1F0;' onchange = "getList(15)" id="Filter15">
<%
	 Uval = database2.getUniqueCol(14);
	for(int k=0;k<Uval.size();k++)
	{
		out.println("<option value="+Uval.get(k)+">"+Uval.get(k)+"</option>");
	}
...
<%
	 Uval = database2.getUniqueCol(15);
	for(int k=0;k<Uval.size();k++)
	{
		out.println("<option value="+Uval.get(k)+">"+Uval.get(k)+"</option>");
	}
...
<%
	 Uval = database2.getUniqueCol(16);
	for(int k=0;k<Uval.size();k++)
	{
		out.println("<option value="+Uval.get(k)+">"+Uval.get(k)+"</option>");
	}
...
<td style='background-color: #C3BEBD;font-size:11'><select  style='width:40px;overflow:hidden;border-radius: 5px;-moz-border-radius:5px;background-color:#F5F1F0;' onchange = "getList(18)" id="Filter18">
<%
	 Uval = database2.getUniqueCol(17);
	for(int k=0;k<Uval.size();k++)
	{
		out.println("<option value="+Uval.get(k)+">"+Uval.get(k)+"</option>");
	}
...
<td style='background-color: #C3BEBD;font-size:11'><select  style='width:40px;overflow:hidden;border-radius: 5px;-moz-border-radius:5px;background-color:#F5F1F0;' onchange = "getList(19)" id="Filter19">
<%
	 Uval = database2.getUniqueCol(18);
	for(int k=0;k<Uval.size();k++)
	{
		out.println("<option value="+Uval.get(k)+">"+Uval.get(k)+"</option>");
	}
...
<%
	 Uval = database2.getUniqueCol(19);
	for(int k=0;k<Uval.size();k++)
	{
		out.println("<option value="+Uval.get(k)+">"+Uval.get(k)+"</option>");
	}
...
<%
	 Uval = database2.getUniqueCol(21);
	for(int k=0;k<Uval.size();k++)
	{
		out.println("<option value="+Uval.get(k)+">"+Uval.get(k)+"</option>");
	}
...
<td style='background-color: #C3BEBD;font-size:11'><td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'>
...
<%
	 Uval = database2.getUniqueCol(24);
...
<tr>
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'><INPUT onclick="sortTable(1);" Style="border-radius: 5px;-moz-border-radius:5px;background-color:#99CC33;" Value = "Sort" TYPE='button'></td>
<td style='background-color: #C3BEBD;font-size:11'><INPUT onclick="sortTable(2);" Style="border-radius: 5px;-moz-border-radius:5px;background-color:#99CC33;" Value = "Sort" TYPE='button'></td>
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'><INPUT onclick="sortTable(7);" Style="border-radius: 5px;-moz-border-radius:5px;background-color:#99CC33;" Value = "Sort" TYPE='button'></td>
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'><INPUT onclick="sortTable(11);" Style="border-radius: 5px;-moz-border-radius:5px;background-color:#99CC33;" Value = "Sort" TYPE='button'></td>
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'><INPUT onclick="sortTable(14);" Style="border-radius: 5px;-moz-border-radius:5px;background-color:#99CC33;" Value = "Sort" TYPE='button'></td>
<td style='background-color: #C3BEBD;font-size:11'><INPUT onclick="sortTable(15);" Style="border-radius: 5px;-moz-border-radius:5px;background-color:#99CC33;" Value = "Sort" TYPE='button'></td>
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'><INPUT onclick="sortTable(19);" Style="border-radius: 5px;-moz-border-radius:5px;background-color:#99CC33;" Value = "Sort" TYPE='button'></td>
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'><INPUT onclick="sortTable(23);" Style="border-radius: 5px;-moz-border-radius:5px;background-color:#99CC33;" Value = "Sort" TYPE='button'></td>
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'></td>
<td style='background-color: #C3BEBD;font-size:11'></td>
...
{   if(Table2.getValue(i, 11).trim().equals("BOX MIMIC")||Table2.getValue(i, 11).trim().equals("MES BOX")||Table2.getValue(i, 11).trim().equals("BOX")||Table2.getValue(i, 6).trim().equals("Cancelled")||Table2.getValue(i, 6).trim().equals("Shipped")||Table2.getValue(i, 6).trim().equals("YB")||Table2.getValue(i, 6).trim().equals("JMET"))
		continue;
	m++;
...
{   
    ...
    date = Table2.getValue(i, 1);
    //System.out.println(id);
    out.println("<tr>");//to change color, check condition for test, add tr style='background:red;'
    out.println("<td align='middle' style='font-family: Arial;font-size: 10pt;background-color: #C3BEBD;'>");
	out.println(m);
	out.println("</td>");
    for(int j=0;j<csize2;j++)
